...
!!location.href.getQueryValue('t') ? $('#type').css('display','-webkit-box') : '';
 ...
 * 返回处理
 */
var backUrl = config.POtherAsset;
...
function successAfter(res){
    var url = config.POtherGaugeResult;
    ...
    location.href = url + '?id=' +res.data.id + '&from=' + encodeURIComponent(location.href);
}
